...
def thaify_directions(directions,subsitute_dict, add_dict):
    print("Thaify directions...")
    new_directions = set()
    num = 0
...
def transform(recipe):
    new_ingredients, subsitute_dict, add_dict = thaify_ingredients(recipe.ingredients,recipe.name)
    new_directions = thaify_directions(recipe.directions, subsitute_dict, add_dict)
